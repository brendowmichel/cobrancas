// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v61
...
function garantirTitulosImportadosAtivosSupabase_(hashes, origemArquivo, nowText) {
  ...
  // Mantem a URL do PostgREST pequena mesmo em arquivos maiores.
  for (let inicio = 0; inicio < listaHashes.length; inicio += 100) {
    const lote = listaHashes.slice(inicio, inicio + 100);
