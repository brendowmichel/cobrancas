// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v15
  ...
  <div id="status-modal" class="modal-backdrop">
    <div class="modal">
      ...
      <div class="form-grid">
        ...
        <label for="status-contato-select">Status de contato</label>
        <select id="status-contato-select">
          <option value="EM ABERTO">EM ABERTO</option>
          <option value="EM CONTATO">EM CONTATO</option>
          <option value="AGENDADO">AGENDADO</option>
        </select>
        <label for="status-cadastro-select">Status de cadastro</label>
        <select id="status-cadastro-select">
