...
<body>
  <main>
    ...
    <p>Use esta tela para executar as rotinas basicas quando o projeto estiver publicado como Web App. O uso principal continua disponivel no menu Cobrancas dentro da planilha.</p>

    <div class="actions">
      <button type="button" onclick="prepararAbas()">Preparar abas</button>
