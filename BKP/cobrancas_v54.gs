// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v54
  ...
  <style type="text/tailwindcss">
    ...
    @layer components {
      ...
      .status-badge {
        ...
        border:1px solid transparent; line-height:1; box-shadow:inset 0 1px 0 rgba(255,255,255,.65);
      }
      ...
      .cadastro-tag { @apply inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase; border:1px solid transparent; box-shadow:inset 0 1px 0 rgba(255,255,255,.65); }
      ...
      .pill { @apply inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold; border:1px solid transparent; box-shadow:inset 0 1px 0 rgba(255,255,255,.65); }
