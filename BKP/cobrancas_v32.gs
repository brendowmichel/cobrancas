// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v32
          ...
          <div id="import-menu" style="display:none;position:absolute;right:0;top:calc(100% + .625rem);width:280px;background:var(--md-surface-container-high);border-radius:20px;box-shadow:var(--md-shadow-3);padding:1.125rem;z-index:100">
            ...
            <div style="display:flex;flex-direction:column;gap:.75rem">
              <div>
                ...
                <input id="arquivo-excel" type="file" accept=".xlsx,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" style="display:none"
                  onchange="document.getElementById('arquivo-nome').textContent=(this.files&&this.files[0])?this.files[0].name:'Nenhum arquivo escolhido'">
