// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v03
...
<body>
  <main>
    ...
    <p>Importe o arquivo Excel de cobrancas diretamente por aqui. O sistema converte o arquivo temporariamente, normaliza os dados e atualiza a base.</p>

    <section class="upload">
      <label for="arquivo-excel">Arquivo Excel</label>
      <input id="arquivo-excel" type="file" accept=".xlsx,.xls,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel">
  ...
  <script>
    ...
    function importarArquivoExcel() {
      ...
      reader.onload = function () {
        ...
        setStatus("Enviando e convertendo arquivo...");
...
function lerRegistrosOrigem_(sheet) {
  ...
  if (!headerInfo) {
    throw new Error(
      "Nao foi possivel detectar o cabecalho da aba " + sheet.getName() +
