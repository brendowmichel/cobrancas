// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v57
...
<head>
  ...
  <style type="text/tailwindcss">
    ...
    @layer components {
      ...
      .cadastro-tag { @apply inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold uppercase; border:1px solid transparent; }
      .cadastro-suspended      { background:#fff7ea; color:#8a5300; border-color:#efbe70; }
      .cadastro-cancelled      { background:#fff0ef; color:#9a1118; border-color:#e19a9b; }
      .cadastro-protested      { background:#fff0ef; color:#9a1118; border-color:#d4555d; }
      .cadastro-permuta        { background:#e7f8f3; color:#006b5a; border-color:#72cdbb; }
      .cadastro-desconsiderado { background:#f6f8fb; color:#526071; border-color:#cbd4df; }
