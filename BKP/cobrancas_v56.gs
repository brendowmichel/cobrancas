// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v56
  ...
  <script>
    ...
    function renderInadimplentes(lista) {
      ...
      lista.forEach(function (item) {
        ...
        tr.innerHTML =
          "<td><div class='cell-nome'>" + clienteNomeHtml(item) + "<span class='cnpj-line'>" + escapeHtml(formatDocumento(item.cnpj_cpf)) + "</span></div></td>" +
    ...
    function atualizarLinhaClienteOtimista(item) {
      ...
      if (tds[0]) tds[0].innerHTML = "<div class='cell-nome'>" + clienteNomeHtml(item) + "<span class='cnpj-line'>" + escapeHtml(formatDocumento(item.cnpj_cpf)) + "</span></div>";
