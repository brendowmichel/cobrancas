...
<head>
  ...
  <style type="text/tailwindcss">
    @layer components {
      ...
      .actions      { width: 210px; min-width: 210px; text-align: right; }
      .version {
  ...
  <main style="max-width:1280px;margin:0 auto;padding:2rem 1.5rem 3rem">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1rem;margin-bottom:1.5rem">
      <div style="background:#fff;border:1px solid #f3f4f6;border-radius:.75rem;box-shadow:0 1px 3px rgba(0,0,0,.06);padding:1.25rem">
        ...
        <strong id="kpi-vencido" style="display:block;font-size:1.5rem;font-weight:700;color:#111827;margin-top:.5rem;font-variant-numeric:tabular-nums;letter-spacing:-.025em">R$ 0,00</strong>
      </div>
      <div style="background:#fff;border:1px solid #f3f4f6;border-radius:.75rem;box-shadow:0 1px 3px rgba(0,0,0,.06);padding:1.25rem">
    ...
    <div class="modal">
      ...
      <div class="form-grid">
        ...
        <div>
          ...
          <select id="status-contato-select" style="display:block;width:100%;border:1px solid #e5e7eb;border-radius:.5rem;background:#fff;color:#374151;font-size:.875rem;padding:.5rem .75rem;outline:none;font-family:inherit">
