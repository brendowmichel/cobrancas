// SISTEMA DE GESTAO DE COBRANCAS - Apps Script v53
...
<head>
  ...
  <style type="text/tailwindcss">
    ...
    @layer components {
      ...
      /* === Chips de status (M3) ============================= */
      .status-badge {
        @apply inline-flex items-center gap-1 px-3 py-1 rounded-lg text-xs font-medium;
        border:1px solid transparent; line-height:1;
      }
      .status-open       { background:var(--md-surface-container-high); color:var(--md-on-surface-variant); border-color:var(--md-outline-variant); }
      .status-contact    { background:var(--md-primary-container); color:var(--md-on-primary-container); border-color:#a8c7fa; }
      .status-scheduled  { background:var(--md-tertiary-container); color:var(--md-on-tertiary-container); border-color:#e4b7f5; }
      .status-scheduled-overdue { background:var(--md-error); color:var(--md-on-error); border-color:var(--md-error); }
      .status-finalizado { background:var(--md-success-container); color:var(--md-on-success-container); border-color:#9bdcb0; }

      .cadastro-tag { @apply inline-flex items-center px-2 py-0.5 rounded-md text-xs font-semibold uppercase; border:1px solid transparent; }
