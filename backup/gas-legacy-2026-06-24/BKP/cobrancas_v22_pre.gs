  ...
  <main style="max-width:1280px;margin:0 auto;padding:2rem 1.5rem 3rem">
    ...
    <div style="background:#fff;border:1px solid #f3f4f6;border-radius:.75rem;box-shadow:0 1px 3px rgba(0,0,0,.06);overflow:hidden">
      ...
      <div style="padding:.625rem 1.25rem;border-bottom:1px solid #f3f4f6">
        <input id="filtro-cliente" type="search" placeholder="Filtrar por nome..." oninput="filtrarInadimplentes(this.value)"
          style="width:100%;height:34px;padding:0 .75rem;font-size:.8125rem;border:1px solid #e5e7eb;border-radius:.5rem;outline:none;color:#111827;background:#fff"
